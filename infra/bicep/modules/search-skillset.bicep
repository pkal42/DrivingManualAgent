...
// Base skills that are always included (DocumentExtraction, TextSplit, Embedding)
var baseSkills = [
  // ======================================================================
...
// Optional image description skills (only added if enabled)
var imageSkills = [
  // ======================================================================
...
// Combine base skills with optional image skills
var allSkills = enableImageDescriptions ? concat(baseSkills, imageSkills) : baseSkills
...
resource skillset 'Microsoft.Search/searchServices/skillsets@2024-06-01-preview' = {
  ...
  properties: {
    ...
    // Skills array is defined in variables section and combines base skills with optional image skills
    skills: allSkills
